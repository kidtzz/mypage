...
date: 2023-09-10T20:21:11+07:00
draft: false
tags: [git, cheatsheet]
...
9. **Commit Management**
    ...
    git reflog
    ```
10. **Submodules, Subtrees, and Advanced Submodules**
    ```
    ...
    ```
11. **Hooks and Automation, and Diff and Merge Tools**
    ```
...
13. **Collaboration**
    ...
    git grep <pattern>
    ```
14. **Bisecting, Debugging, and Performance Issues**
    ```
